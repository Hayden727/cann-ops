...
#include "../foreach_abs/foreach_utils/foreach_one_scalar_quaternary.h"
...
extern "C" __global__ __aicore__ void foreach_addcdiv_scalar_list(GM_ADDR tensor1, GM_ADDR tensor2, GM_ADDR tensor3, GM_ADDR scalar,
