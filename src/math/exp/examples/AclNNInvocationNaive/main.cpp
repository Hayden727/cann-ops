...
int main(int argc, char **argv)
{
    ...
    std::vector<int64_t> inputXShape = {10, 10};
    std::vector<int64_t> outputYShape = {10, 10};
    ...
    // 计算workspace大小并申请内存
    ret = aclnnExpGetWorkspaceSize(inputX, 2.0f, 2.0f, 1.0f, outputY, &workspaceSize, &executor);
