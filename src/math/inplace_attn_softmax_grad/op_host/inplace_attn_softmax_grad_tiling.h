...
#ifndef INPLACE_ATTN_SOFTMAX_GRAD_TILING_H
#define INPLACE_ATTN_SOFTMAX_GRAD_TILING_H
...
BEGIN_TILING_DATA_DEF(InplaceAttnSoftmaxGradTilingData)
...
END_TILING_DATA_DEF;
REGISTER_TILING_DATA_CLASS(InplaceAttnSoftmaxGrad, InplaceAttnSoftmaxGradTilingData)

struct InplaceAttnSoftmaxGradCompileInfo {
...
struct InplaceAttnSoftmaxGradTilingParam {
...
enum class InplaceAttnSoftmaxTilingKey : uint32_t {
...
#endif  // INPLACE_ATTN_SOFTMAX_GRAD_TILING_H