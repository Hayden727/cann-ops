...
#ifndef INPLACE_ATTN_SOFTMAX_GRAD_H
#define INPLACE_ATTN_SOFTMAX_GRAD_H
...
class InplaceAttnSoftmaxGrad : public InplaceAttnSoftmaxGradBase<mmType, dataType, isAligned, isCast> {
public:
    __aicore__ inline InplaceAttnSoftmaxGrad(mmType &mm) : InplaceAttnSoftmaxGradBase<mmType, dataType, isAligned, isCast>(mm)
    {}
...
#endif  // INPLACE_ATTN_SOFTMAX_GRAD_H