 ...
 */
 ...
 {
     // define operator
     std::vector<int64_t> shape { 7, 2045 };
 ...
 bool SetInputData(OpRunner &runner)
 {
     ...
     ReadFile("../input/input_clip_value_min.bin", fileSize, runner.GetInputBuffer<void>(1), runner.GetInputSize(1));
     ReadFile("../input/input_clip_value_max.bin", fileSize, runner.GetInputBuffer<void>(2), runner.GetInputSize(2));
