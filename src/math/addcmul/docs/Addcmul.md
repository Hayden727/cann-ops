...
```c++
REG_OP(Addcmul)
    .INPUT(self, TensorType({DT_FLOAT, DT_FLOAT16, DT_BF16, DT_INT32}))
    .INPUT(tensor1, TensorType({DT_FLOAT, DT_FLOAT16, DT_BF16, DT_INT32}))
    .INPUT(tensor2, TensorType({DT_FLOAT, DT_FLOAT16, DT_BF16, DT_INT32}))
    .INPUT(value, ScalarType({DT_FLOAT, DT_FLOAT16, DT_BF16, DT_INT32}))
    .OUTPUT(out, TensorType({DT_FLOAT, DT_FLOAT16, DT_BF16, DT_INT32}))
