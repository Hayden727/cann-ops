...
public:
  ...
  __aicore__ inline void Init(GM_ADDR x1, GM_ADDR x2, GM_ADDR y,
      const GreaterEqualTilingData& tiling_data) {
...
private:
  __aicore__ inline void ComputeHalf(AscendC::LocalTensor<half> x1_local, AscendC::LocalTensor<half> x2_local, AscendC::LocalTensor<half> y_compute) {
    AscendC::Max(y_compute, x2_local, x1_local, this->tile_cache);
  ...
  __aicore__ inline void ResovleTiling(const GreaterEqualTilingData& tiling_data) {
...
extern"C" __global__ __aicore__ void greater_equal(GM_ADDR x1, GM_ADDR x2, GM_ADDR y, GM_ADDR workspace, GM_ADDR tiling) {
  ...
  GreaterEqualK::KernelGreaterEqual<DTYPE_X1> op;
