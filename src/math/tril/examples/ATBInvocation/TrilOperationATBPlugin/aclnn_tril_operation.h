...
namespace common{
    ...
    class TrilOperation: public atb::Operation{
    public:
        TrilOperation(const std::string &name, TrilAttrParam param);
        ...
        {
            return inputNum; // 算子入参个数
        }

        uint32_t GetOutputNum() const
        {
            return outputNum; // 算子出参个数
        }
