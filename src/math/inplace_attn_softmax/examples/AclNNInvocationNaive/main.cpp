...
#include <fcntl.h>
#include "acl/acl.h"
#include "aclnn_inplace_attn_softmax.h"
...
int main(int argc, char **argv)
{
    ...
    std::vector<int64_t> inputXShape = {8,4096};
    ...
    // 计算workspace大小并申请内存
    ret = aclnnInplaceAttnSoftmaxGetWorkspaceSize(inputX, &workspaceSize, &executor);
    ...
    // 执行算子
    ret = aclnnInplaceAttnSoftmax(workspaceAddr, workspaceSize, executor, stream);
    ...
    //写出数据
    WriteFile("../output/output_z.bin", *output1, inputXShapeSize * dataType);
