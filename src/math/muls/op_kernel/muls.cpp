...
private:
    ...
    {
        AscendC::printf("commomclass");
        LocalTensor<TYPE_X> xLocal = inQueueX.DeQue<TYPE_X>();
        LocalTensor<TYPE_X> yLocal = outQueueY.AllocTensor<TYPE_X>();
        AscendC::DumpTensor(xLocal, 1, this->processDataNum);
        AscendC::printf("compute value: %f\n", this->value);
        ...
        AscendC::DumpTensor(yLocal, 2, this->processDataNum);
