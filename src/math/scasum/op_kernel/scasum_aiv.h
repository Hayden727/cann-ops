...
template <typename T>
__aicore__ inline void ScasumAIV<T>::Init(GM_ADDR inDevice, GM_ADDR outDevice, uint32_t n, uint32_t offset,
                                         uint32_t calNum)
{
...
template <typename T>
__aicore__ inline void ScasumAIV<T>::Process()
{
    SetAtomicAdd<T>();
...
template <typename T>
__aicore__ inline void ScasumAIV<T>::SingleIteration(uint32_t offset, uint32_t dataCount)
{
...
template <typename T>
__aicore__ inline void ScasumAIV<T>::SingleIterationAligned(uint32_t offset, uint32_t dataCount)
{
...
template <typename T>
__aicore__ inline void ScasumAIV<T>::CopyIn(uint32_t offset, uint32_t dataCount)
{
...
template <typename T>
__aicore__ inline void ScasumAIV<T>::CopyInPad(uint32_t offset, uint32_t dataCount)
{
...
template <typename T>
__aicore__ inline void ScasumAIV<T>::Compute(uint32_t dataCount)
{
...
template <typename T>
__aicore__ inline void ScasumAIV<T>::CopyOut()
{
