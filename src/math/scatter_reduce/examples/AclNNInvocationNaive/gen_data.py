...
def gen_golden_data_simple():
    ...
    input_index = np.random.uniform(0,dimSize-1, [dimSize, dimSize]).astype(target_type)
    ...
    res = torch.scatter_reduce(input=input_x_cpu,dim=dim,index=input_index_cpu,src=input_src_cpu,reduce=reduce,include_self=include_self)
