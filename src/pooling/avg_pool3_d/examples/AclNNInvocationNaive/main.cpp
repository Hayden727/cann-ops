...
int main(int argc, char **argv)
{
    ...
    ret = aclnnAvgPool3dGetWorkspaceSize(self,
                                       ...
                                       &workspaceSize,
                                       &executor);
    CHECK_RET(ret == ACL_SUCCESS, LOG_PRINT("aclnnAvgPool3dGetWorkspaceSize failed. ERROR: %d\n", ret); return FAILED);
    ...
    CHECK_RET(ret == ACL_SUCCESS, LOG_PRINT("aclnnAvgPool3d failed. ERROR: %d\n", ret); return FAILED);
    ...
    //写出数据
    WriteFile("../output/out.bin", *out1, outShapeSize * dataType);
