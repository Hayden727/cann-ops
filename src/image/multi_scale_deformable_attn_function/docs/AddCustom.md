...
图1 MultiScaleDeformableAttnFunction推理计算流程图

![image](https://obs-book.obs.cn-east-2.myhuaweicloud.com/MultiScaleDeformableAttnFunction.png)

MultiScaleDeformableAttnFunction由Add操作组成，计算过程只有1步：
...
- **参数说明：**
  ...
  - workspaceSize（uint64\_t，入参）：在Device侧申请的workspace大小，由第一段接口aclnnMultiScaleDeformableAttnFunctionGetWorkspaceSize获取。
