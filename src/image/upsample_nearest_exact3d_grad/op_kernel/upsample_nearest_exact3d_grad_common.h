...
/*!
 * \file upsample_nearest_exact3d_grad_common.h
 * \brief
 */
#ifndef UPSAMPLE_NEARESTEXACT3D_GRAD_COMMON_H
#define UPSAMPLE_NEARESTEXACT3D_GRAD_COMMON_H
...
#endif  // UPSAMPLE_NEARESTEXACT3D_GRAD_COMMON_H