...
/*!
 * \file upsample_linear1d_common.h
 * \brief
 */
#ifndef UPSAMPLE_LINEAR1D_COMMON_H
#define UPSAMPLE_LINEAR1D_COMMON_H
...
{
    float iLambda = Min(Max(static_cast<float>(i_rel_idx - i_min), (float)0.0), (float)1.0);
    return iLambda;
};
...
#endif  // UPSAMPLE_LINEAR1D_COMMON_H