...
### 算子描述
对由多个输入通道组成的输入信号应用双三次抗锯齿算法进行上采样。
...
<tr><td align="center">output_size</td><td align="center">attr</td><td align="center">int32</td><td align="center">ND</td></tr>
...
### 算子包编译部署
  ...
  - 执行编译
    ...
    ```bash
    bash build.sh -n upsample_bicubic2d_aa
    ```
