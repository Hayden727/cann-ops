...
<tr><td align="center">output_size</td><td align="center">list</td><td align="center">int32</td><td align="center">ND</td></tr>
...
### 算子包编译部署
  ...
  - 执行编译
    ...
    ```bash
    bash build.sh -n resize_upsample_trilinear
    ```
