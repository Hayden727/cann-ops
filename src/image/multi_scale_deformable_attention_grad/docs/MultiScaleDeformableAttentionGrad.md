...
图1 MultiScaleDeformableAttentionGrad推理计算流程图

![image](https://obs-book.obs.cn-east-2.myhuaweicloud.com/MultiScaleDeformableAttentionGrad.png)

MultiScaleDeformableAttentionGrad由Add操作组成，计算过程只有1步：
...
- **参数说明：**
  ...
  - workspaceSize（uint64\_t，入参）：在Device侧申请的workspace大小，由第一段接口aclnnMultiScaleDeformableAttentionGradGetWorkspaceSize获取。
