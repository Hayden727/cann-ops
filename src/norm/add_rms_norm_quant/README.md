...
### 算子包编译部署
  ...
  - 执行编译
    ...
    ```bash
    bash build.sh -n add_rms_norm_quant
    ```
...
<table>
    <th>目录</th><th>描述</th>
    <tr>
        <td><a href="./examples/AclNNInvocationNaive"> AclNNInvocationNaive</td><td>通过aclnn调用的方式调用AddRmsNormQuant算子。</td>
    </tr>
</table>
