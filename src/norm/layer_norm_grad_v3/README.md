...
### 算子包编译部署
  ...
  - 执行编译
    ...
    ```bash
    bash build.sh -n layer_norm_grad_v3
    ```
...
<table>
    <th>目录</th><th>描述</th>
    <tr>
        <td><a href="./examples/AclNNInvocationNaive"> AclNNInvocationNaive</td><td>通过aclnn调用的方式调用LayerNormGradV3算子。</td>
    </tr>
</table>
