...
namespace ops {
static ge::graphStatus InferShapeForGeGluV3(gert::InferShapeContext* context) {
    ...
    GE_OP_LOGE("GEGLUV3", "The value of attr [dim] must be in the range [-%zu, %zu], but got [%ld].",
...
IMPL_OP_INFERSHAPE(GeGluV3).InferShape(InferShapeForGeGluV3);
}  // namespace ops