...
public:
    explicit Conv3DBackpropFilterV2Tiling(gert::TilingContext *context) : TilingBaseClass(context)
    {
        Reset();
    }
...
protected:
    ...
    void InitTilingValue_1982(TilingValueDw& tilingParams);
    void InitTilingValue_1971(TilingValueDw& tilingParams);
    void InitCalTilingValue(TilingValueDw& tilingParams);
    void CalcRealGroup(TilingValueDw& tilingParams);
    void SetTilingValue(TConv3DDwTilingAdvance& dwt, const TilingValueDw& tilingParams);
    void SetDwTilingFromTbeTiling();
    bool CheckAttrs(cachetiling::Conv3DBpFilterTilingParam &tilingParams);
    bool CheckFormat(cachetiling::Conv3DBpFilterTilingParam &tilingParams);
    bool GetTbeTiling();
    ...
    uint32_t coreNum_ = 1;
    bool enableGroupEnlarger_ = true;
