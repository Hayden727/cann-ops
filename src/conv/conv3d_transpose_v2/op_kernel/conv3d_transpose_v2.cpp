...
extern "C" __global__ __aicore__ void conv3d_transpose_v2(GM_ADDR input_size, GM_ADDR x, GM_ADDR filter, GM_ADDR bias,
                                                          ...
                                                          GM_ADDR tiling)
{
    ...
    if (TILING_KEY_IS(0)) {
        Conv3dDx<DTYPE_FILTER, FORMAT_FILTER, DTYPE_X, FORMAT_X, DTYPE_Y, FORMAT_Y,
