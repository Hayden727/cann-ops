## `AscendQuantV2`自定义算子样例说明 
本样例通过`Ascend C`编程语言实现了`AscendQuantV2`算子。

### 算子描述
`AscendQuantV2`算子对由多个输入通道组成的输入信号应用2D双三次上采样。
...
<table>
    ...
    <tr>
        <td><a href="./examples/AclOfflineModel"> AclOfflineModel</td><td>通过aclopExecuteV2调用的方式调用AscendQuantV2算子。</td>
    </tr>
    <tr>
        <td><a href="./examples/AclOnlineModel"> AclOnlineModel</td><td>通过aclopCompile调用的方式调用AscendQuantV2算子。</td>
    </tr>
    <tr>
        <td><a href="./examples/CppExtensions"> CppExtensions</td><td>Pybind方式调用AscendQuantV2算子。</td>
    </tr>
    <tr>
        <td><a href="./examples/PytorchInvocation"> PytorchInvocation</td><td>通过pytorch调用的方式调用AscendQuantV2算子。</td>
    </tr>
    <tr>
        <td><a href="./examples/TensorflowInvocation"> TensorflowInvocation</td><td>通过tensorflow调用的方式调用AscendQuantV2算子。</td>
    </tr>
</table>
