...
namespace ops {
class Edge32C3 : public OpDef {
public:
    explicit Edge32C3(const char* name) : OpDef(name)
    {
        this->Input("input")
            .ParamType(REQUIRED)
