...
class KernelEdgeSubDilateVerC1Threshol8u
{
public:
    __aicore__ inline KernelEdgeSubDilateVerC1Threshol8u() {}
...
private:
    ...
    __aicore__ inline void Compute(int32_t progress)
    {
        ...
        Max(tmp1Local, tmp1Local, tmp2Local, this->processDataNum);
        Mins(tmp1Local, tmp1Local, (half)1, this->processDataNum);
...
extern "C" __global__ __aicore__ void edge_sub_dilate_ver_c1_threshol8u(GM_ADDR input, GM_ADDR out, GM_ADDR workspace, GM_ADDR tiling) {
    GET_TILING_DATA(tiling_data, tiling);
    TPipe pipeIn;
    KernelEdgeSubDilateVerC1Threshol8u op;
